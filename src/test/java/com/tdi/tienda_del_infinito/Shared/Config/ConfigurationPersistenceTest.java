...
@ComponentScan(value = {"com.tdi.tienda_del_infinito.*"}, excludeFilters = @ComponentScan.Filter(Configuration.class))
@EnableJpaAuditing(auditorAwareRef = "customAuditorAware")
@EnableJpaRepositories("com.tdi.tienda_del_infinito.*")
